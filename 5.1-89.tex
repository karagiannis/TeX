...
\draw[ thick,->,domain=3.5:1.7, smooth, variable=\x, black] plot ({\x}, {(0.5+(3.5-0.5)*(abs((\x-3)/(1-3)))^3});
\draw[ thick,domain=1.8:1, smooth, variable=\x, black] plot ({\x}, {(0.5+(3.0-0.5)*(abs((\x-3)/(1-3)))^3}) node[scale=0.7, left]{2};
%Isokor kompression (Tryckökning)
\draw[thick,->] (1,3.0)--(1,3.0);
\draw[thick] (1,3.0)--(1,3.5) node[scale=0.7, above]{3};
%Polytropisk expansion
\draw[ thick,->,domain=1:1.7, smooth, variable=\x, black] plot ({\x}, {(0.5+(3.5-0.5)*(abs((\x-3)/(2-3)))^2});
\draw[ thick,domain=1.7:3.5, smooth, variable=\x, black] plot ({\x}, {(0.5+(3.5-0.5)*(abs((\x-3)/(2-3)))^2}) node[scale=0.7, left]{4};
%Isokor tryckminskning
\draw[thick,->] (3.5,1.25)--(3.5,1.0);
\draw[thick] (3.5,1.0)--(3.5,0.7) node[scale=0.7, right]{1};
